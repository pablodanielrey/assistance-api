...
RUN git clone https://github.com/pablodanielrey/assistance-api.git /src/assistance && echo "2022061201"
...
COPY --from=0 /src/assistance/dist/assistance_api-2.0.0-py3-none-any.whl ./

# instalo el sistema.

RUN pip install -U pip
RUN pip install /src/assistance_api-2.0.0-py3-none-any.whl
