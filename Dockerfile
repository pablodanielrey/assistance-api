...
RUN git clone git@github.com:pablodanielrey/assistance-api.git ./assistance && echo "2022061201"
...
COPY --from=0 /src/assistance/dist/ditesi_issues_ingress-0.0.5-py3-none-any.whl ./

# instalo el sistema.

RUN pip install -U pip
RUN pip install /src/ditesi_issues_ingress-0.0.5-py3-none-any.whl
