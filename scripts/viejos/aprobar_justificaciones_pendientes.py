            ...
            for jnn in simple:
                ...
                for j in cur2.fetchall():
                    ...
                    if status[0] == 1:
                        ...
                        cur2.execute('insert into assistance.justification_status (id,status,user_id,justification_id,created,date) values (%s,%s,%s,%s,%s,%s)', (tjid, 2, '1', jid, tfecha, tfecha))
                        cur2.commit()
